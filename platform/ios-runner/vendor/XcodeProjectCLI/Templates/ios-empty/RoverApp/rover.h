...
bool rover_is_reloading(void *handle);
...
void rover_pointer_down(void *handle, float x, float y);
void rover_pointer_move(void *handle, float x, float y);
void rover_pointer_up(void *handle, float x, float y);
