...
pub trait PropsParser {
    fn parse_view_props(&self) -> Params<ViewProps>;
    fn parse_text_props(&self) -> Params<TextProps>;
    fn parse_button_props(&self) -> Params<ButtonProps>;
}

impl PropsParser for Table<'_> {
    fn parse_view_props(&self) -> Params<ViewProps> {
