...
impl FfiRuntime {
    fn new(callbacks: HostCallbacks) -> Result<Self, String> {
        Ok(Self {
            runtime: IosRuntime::new(callbacks).map_err(|e| e.to_string())?,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn rover_ios_init(callbacks: HostCallbacks) -> *mut FfiRuntime {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn rover_ios_init_with_callbacks(
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn rover_ios_free(runtime: *mut FfiRuntime) {
    if !runtime.is_null() {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn rover_ios_load_lua(
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn rover_ios_tick(runtime: *mut FfiRuntime) -> i32 {
    if runtime.is_null() {
        return 1;
    }
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn rover_ios_next_wake_ms(runtime: *mut FfiRuntime) -> i32 {
    if runtime.is_null() {
        return -1;
    }
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn rover_ios_dispatch_click(runtime: *mut FfiRuntime, id: u32) -> i32 {
    if runtime.is_null() {
        return 1;
    }
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn rover_ios_dispatch_input(
    runtime: *mut FfiRuntime,
    id: u32,
    value: *const c_char,
    len: usize,
) -> i32 {
    dispatch_text(runtime, id, value, len, false)
}

#[unsafe(no_mangle)]
pub unsafe extern "C" fn rover_ios_dispatch_submit(
    runtime: *mut FfiRuntime,
    id: u32,
    value: *const c_char,
    len: usize,
) -> i32 {
    dispatch_text(runtime, id, value, len, true)
}

#[unsafe(no_mangle)]
pub unsafe extern "C" fn rover_ios_dispatch_toggle(
    runtime: *mut FfiRuntime,
    id: u32,
    checked: bool,
) -> i32 {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn rover_ios_set_viewport(
    runtime: *mut FfiRuntime,
    width: u16,
    height: u16,
) -> i32 {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn rover_ios_last_error(runtime: *mut FfiRuntime) -> *const c_char {
    if runtime.is_null() {
        return std::ptr::null();
    }
