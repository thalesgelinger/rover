...
- [Context API](/docs/server/context-api/) - Access route parameters and request data
- [Backend Server](/docs/server/backend-server/) - Learn more about building APIs
