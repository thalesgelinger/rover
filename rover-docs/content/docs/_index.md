...
Rover is an opinionated Lua runtime for full-stack apps. Build APIs, data layers, and UI flows with one runtime and one language.
...
Use Rover when you want:

- one stack for backend + client runtime logic
- opinionated defaults that remove setup overhead
- practical APIs for routing, IO, config, and debugging
