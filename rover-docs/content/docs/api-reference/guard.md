...
> **Tip:** Use `rover.guard` for general validation and `rover.db.guard` for database schemas. `rover.db.guard` extends the base guard with DB modifiers.
